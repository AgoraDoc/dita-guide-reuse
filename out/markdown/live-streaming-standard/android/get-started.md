# Get Started with Interactive Live Streaming Standard for Android {#get-started-with-product-name-for-platform}
...
## Implement a client for Interactive Live Streaming Standard {#implement-a-client-for-product-name}
...
### Implement the Interactive Live Streaming Standard logic {#implement-the-product-name-logic}
...
Now you have created the Interactive Live Streaming Standard functionality, start and stop the app. In this implementation, a live streaming starts when the user opens your app. The live streaming ends when the user closes your app.
